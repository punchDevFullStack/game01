...
public class Bullet2Screen2 extends Screen {
    ...
    private ImageLayer bullet2Screen2Layer;
    ...
    private int e = 0;
    public Bullet2Screen2(final World world, final float x_px, final float y_px) {
        this.x = x_px;
        this.y = y_px;
        this.world = world;

        Image bullet2Screen2Image = assets().getImage("images/bullet2.png");
        bullet2Screen2Layer  = graphics().createImageLayer(bullet2Screen2Image);
    ...
    public void paint(Clock clock){
        ...
        bullet2Screen2Layer.setTranslation(
    ...
    public void contact(Contact contact){
        // body.setActive(false);
        checkContact = true;
        bullet2Screen2Layer.setVisible(false);
    }
