...
public class Bullet3Screen2 extends Screen {
    ...
    private ImageLayer bullet3Screen2Layer;
    ...
    private int e = 0;
    public Bullet3Screen2(final World world, final float x_px, final float y_px) {
        this.x = x_px;
        this.y = y_px;
        this.world = world;

        Image bullet3Screen2Image = assets().getImage("images/bullet2.png");
        bullet3Screen2Layer  = graphics().createImageLayer(bullet3Screen2Image);
    ...
    public void paint(Clock clock){
        ...
        bullet3Screen2Layer.setTranslation(
    ...
    public void contact(Contact contact){
        // body.setActive(false);
        checkContact = true;
        bullet3Screen2Layer.setVisible(false);
    }
