...
import sut.game01.core.Character.InScreen2.Bullet3Screen2;
import sut.game01.core.Screen.GameScreen2;
import sut.game01.core.sprite.Sprite;
import sut.game01.core.sprite.SpriteLoader;
import tripleplay.game.Screen;

public class MilitiaScreen2 extends Screen{
    ...
    public MilitiaScreen2(final World world, final float x_px, final float y_px) {
        this.x = x_px;
        this.y = y_px;
