...
import sut.game01.core.Character.InScreen2.Bullet4Screen2;
...
public class PensionerScreen2 extends Screen{
  ...
  /*  public void shooting(){
        if (checkContact == false){
            bullet4Screen2 = new Bullet4Screen2(world,body.getPosition().x / GameScreen2.M_PER_PIXEL ,body.getPosition().y / GameScreen2.M_PER_PIXEL-20);
